          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] mb:text-[60px] md:leading-[70px]">
                  We help patients live a healthy, longer life.
                </h1>
                <p className="text__para">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. In
                  nemo sapiente ab alias quo sed aperiam, atque quasi quibusdam
                  perferendis, quos eius nisi quisquam deserunt eum dolorem
                  minus? Ipsam, nisi.
                </p>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div
                className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5
              z-20 p-2 pb-3 lg:pt-4 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]"
              >
                ...
                <div
                  className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px]
                lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor 
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  ...
                  font-[700] text-headingColor">Wayne Collins</h4>
                </div>
